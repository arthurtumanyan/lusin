...
${OBJECTDIR}/lusin_store.o: nbproject/Makefile-${CND_CONF}.mk lusin_store.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lusin_store.o lusin_store.c

${OBJECTDIR}/lusin_store_config.o: nbproject/Makefile-${CND_CONF}.mk lusin_store_config.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lusin_store_config.o lusin_store_config.c

${OBJECTDIR}/lusin_store_log.o: nbproject/Makefile-${CND_CONF}.mk lusin_store_log.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lusin_store_log.o lusin_store_log.c

${OBJECTDIR}/lusin_store_memory.o: nbproject/Makefile-${CND_CONF}.mk lusin_store_memory.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lusin_store_memory.o lusin_store_memory.c

${OBJECTDIR}/lusin_store_mysql.o: nbproject/Makefile-${CND_CONF}.mk lusin_store_mysql.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lusin_store_mysql.o lusin_store_mysql.c

${OBJECTDIR}/lusin_store_network.o: nbproject/Makefile-${CND_CONF}.mk lusin_store_network.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lusin_store_network.o lusin_store_network.c

${OBJECTDIR}/lusin_store_protocol.o: nbproject/Makefile-${CND_CONF}.mk lusin_store_protocol.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lusin_store_protocol.o lusin_store_protocol.c

${OBJECTDIR}/lusin_store_signal.o: nbproject/Makefile-${CND_CONF}.mk lusin_store_signal.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lusin_store_signal.o lusin_store_signal.c
